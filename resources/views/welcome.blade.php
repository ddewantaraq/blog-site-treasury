...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <div class="grid gap-8 lg:@if($count == 0)grid-cols justify-center @else grid-cols-2 @endif">
        @forelse ($blogs as $blog)
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex justify-between items-center">
                        ...
                        <a href="{{route('blog.detail', $blog->id)}}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                        Read more
        ...
        @empty
            <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Wait until our first blog, stay tuned!</h2>
        @endforelse                
      </div>  
  </div>
</section>
